...
export let DateTimePickerWidget = (_dec = customElement('datetime-picker'), _dec2 = bindable('label'), _dec3 = bindable('onenterpressed'), _dec4 = bindable('onblur'), _dec5 = bindable({
  ...
  defaultValue: false,
  defaultBindingMode: bindingMode.oneWay
}), _dec11 = inject(Element), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = _dec6(_class = _dec7(_class = _dec8(_class = _dec9(_class = _dec10(_class = _dec11(_class = class DateTimePickerWidget {
